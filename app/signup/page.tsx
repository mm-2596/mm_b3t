    ...
    return (
      <div className="min-h-screen bg-[#0a0f1a] flex items-center justify-center p-4">
        <div className="w-full max-w-sm text-center">
          ...
          <h2 className="text-xl font-bold text-gray-100 mb-2">¡Revisa tu email!</h2>
          <p className="text-gray-400 text-sm mb-6">
            Hemos enviado un enlace de confirmación a <strong className="text-gray-200">{email}</strong>.
    ...
    <div className="min-h-screen bg-[#0a0f1a] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-gray-700/50 bg-gray-800/50 backdrop-blur-sm p-8">
          <h2 className="text-lg font-semibold text-gray-100 mb-6">Crear cuenta</h2>
